...
def Frame_parametre(event, win, content_frame, label_photo_user, text_label_user_name):
    ...
    colors = [[color_menu, color_content, color_zone, color_text, color_soustext, color_autretext, color_scroll, color_icon_type],
              [color_menu, color_content, color_zone, color_text, color_soustext, color_autretext, color_scroll, color_icon_type],
              [color_menu, color_content, color_zone, color_text, color_soustext, color_autretext, color_scroll, color_icon_type]]
    ...
    for q in range(3):
        ...
        for frame_range in split:
            for i in range(frame_range[0], frame_range[1]):
                ...
                x2 = x1 + square_size
                y2 = square_size + y1
                canvas.create_rectangle(x1, y1, x2, y2, fill=colors[q][i-1], outline=color_icon_type)
